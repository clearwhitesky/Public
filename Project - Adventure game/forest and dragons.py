...
def story_board(hero):  # WIP
    if hero['story'] == "intro":  # FIXED
        print_pause("++++++++++++++++++++++++++++++++++++++++++", 1)
        print_pause("+ ____|                   |     _ )      +", 1)
        print_pause("+ |    _ \   __| _ \  __| __|   _ \ \    +", 1)
        print_pause("+ __| (   | |    __/\__ \ |    ( `  <    +", 1)
        print_pause("+_|  \___/ _|  \___|____/\__| \___/\/    +", 1)
        print_pause("+                                        +", 1)
        print_pause("+ __ \                                   +", 1)
        print_pause("+ |   |  __| _` |  _` |  _ \  __ \   __| +", 1)
        print_pause("+ |   | |   (   | (   | (   | |   |\__ \ +", 1)
        print_pause("+____/ _|  \__,_|\__, |\___/ _|  _|____/ +", 1)
        print_pause("+                |___/                   +", 1)
        print_pause("++++++++++++++++++++++++++++++++++++++++++", 1)
        input('Press [enter] key to continue\n')
        print_pause(">>> It is the medieval era. You woke up in a winding woods.", 2)
                ...
                while hero['name'] == 'NoName':
                    ...
                    if x == '1':
                        ...
                        if a == '1':
                            ...
                            print_pause(f"\n>>> Howdy {hero['name']}! What bring you here?", 2)
                            if i == 1:
                        ...
                        hero['name'] = 'stranger'
                        print_pause(f"\n>>> Hey Stranger! State your purpose here! Shouted the guards.", 2)
                        option = "[4] Visit the Inn | [5] Take a look in the Pub | [6] Leave town"
                        print_option(hero)
                        navigation_menu(hero)
                    else:
                        invalid_selection()
        ...
        if hero['name'] == 'stranger':
            print_pause(f"\n>>> Come on in stranger. \"WOULD\" you like to stay for a night?\n", 2)
            a = input('[1] Yes | [2] No\n > ')
            while a != '1' and a != '2':
                invalid_selection()
                print("\n>>> Would like to stay for a night?")
                a = input('[1] Yes | [2] No\n > ')
            if a == '1':
                print('stay for a night')
            elif a == '2':
                print("no")
        else:
